...
import { tokenAdd } from "../../Store/action/accessTokenAction";
  ...
  const loginWithOAuth = () => {
    if (selectedOrganization != "") {
      ...
      const permittedEmails = [
        "vigu1401@outlook.com",
        "viguito1401@outlook.com",
        "brando.m@wise-sales.com",
        "onelab_anuradha@cinestox.com",
        "anuradhamunde25@outlook.com",
        "anumunde123@outlook.com",
        "anumunde10@outlook.com",
      ];
      ...
      {loading ? ( // Display the animation while loading
        ...
        <div className="loginPage">
          ...
          <div className="loginCont-1">
            <img src={logo} alt="Logo" style={{ width: "127.90px", height: "129.89px" }} />
