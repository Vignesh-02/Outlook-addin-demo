...
//   const [senderDomain, setSenderDomain] = useState(null);
  ...
  const handleLaunch = (vendordetail) => {
    console.log("Vendor Details in outlook: ", vendordetail)
    const accessToken = '';
    const sendMailVendor = 'https://graph.microsoft.com/v1.0/me/sendMail';
